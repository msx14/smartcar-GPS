...
#define IPS_REST_PIN    A25             //液晶复位引脚定义
#define IPS_DC_PIN 	    A24	            //液晶命令位引脚定义
...
void IPS_DispChar(uint16 x, uint16 y, uint8 data);
void IPS_DispString(uint16 x, uint16 y, int8* Data);
#endif
