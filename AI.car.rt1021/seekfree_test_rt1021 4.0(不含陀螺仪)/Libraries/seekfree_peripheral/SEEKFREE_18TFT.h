...
#define TFT_SCL     SPI1_SCK_B10    //定义SPI_SCK引脚
#define TFT_SDA     SPI1_MOSI_B12   //定义SPI_MOSI引脚
#define TFT_SDA_IN  SPI1_MISO_B13   //定义SPI_MISO引脚  TFT没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
#define TFT_CS      SPI1_CS0_B11    //定义SPI_CS引脚
...
void LCD_DispString(uint16 x,uint16 y,uint8 dat[]);
