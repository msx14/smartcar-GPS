...
void train_ad_collection(void)
{
  ...
  { 
    ad1_m=adc_mean_filter(ADC_1, LO_L_com,2);
    ad2_m=adc_mean_filter(ADC_1, LI_L_com,2);
    ad3_m=adc_mean_filter(ADC_2, M_L_com,2);
    ad4_m=adc_mean_filter(ADC_1, RI_L_com,2);
    ad5_m=adc_mean_filter(ADC_1, RO_L_com,2);
    ...
    ad6_m=adc_mean_filter(ADC_1, belly_R_L_com,2);
    ad7_m=adc_mean_filter(ADC_2, belly_L_L_com,2);
    ...
    ad8_m=adc_mean_filter(ADC_1, outL_L_com,2);
    ad9_m=adc_mean_filter(ADC_1,outR_L_com,2);
    ad10_m=adc_mean_filter(ADC_1, outM_L_com,2);
...
{	
           ...
           smotor_num = (int)((float)(smotor_angle)/420.0*127.0);
						send_buff[9]=smotor_num;
