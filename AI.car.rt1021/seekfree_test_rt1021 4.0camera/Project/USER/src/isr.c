...
//		if(stop_tiktok==2) run_t0 =g_tick1; 
		if(stop_judge==4&&stop_tiktok>1500)
    {
			run_t1=g_tick1 -run_t0;
			runtime=run_t1/10000;
      global_judge=1;
 //    PRINTF("TIME :%.2f",runtime);}
//		if(stop_tiktok==0) time_tiktok=stop_tiktok-time_tiktok;
		}
